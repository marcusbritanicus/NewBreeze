...
# Source Paths
INCLUDEPATH += . Core Core/AppFile Core/Archive Core/ArgParser Core/CoreTools Core/DeleteManager Core/DeviceInfo
INCLUDEPATH += Core/DeviceInfo/QVolumeInfo Core/FileIO Core/FSWatcher Core/IconProvider Core/MimeHandler Core/MultiFile Core/SelectionArea
INCLUDEPATH += Core/Server Core/StandardPaths Core/SystemInfo Core/XDG Gui Gui/Dialogs Gui/Dialogs/FileDialog Gui/Dialogs/PropertiesDialog
INCLUDEPATH += Gui/Dialogs/SettingsManager Gui/ModelViews Gui/ModelViews/Models Gui/ModelViews/Models/ApplicationsModel
INCLUDEPATH += Gui/ModelViews/Models/CatalogModel Gui/ModelViews/Models/FileSystemModel Gui/ModelViews/Models/SidePanelModel
INCLUDEPATH += Gui/ModelViews/Models/TrashModel Gui/ModelViews/Views Gui/ModelViews/Views/AppsView Gui/ModelViews/Views/CatalogView
INCLUDEPATH += Gui/ModelViews/Views/IconView Gui/ModelViews/Views/OpenWithView Gui/ModelViews/Views/SidePanelView Gui/ModelViews/Views/TrashView
INCLUDEPATH += Gui/NewBreezeUI Gui/Others Gui/Others/Settings Gui/Widgets Gui/Widgets/AddressBar Gui/Widgets/BreadCrumbsBar Gui/Widgets/Buttons
INCLUDEPATH += Gui/Widgets/ContextMenu Gui/Widgets/CustomActions Gui/Widgets/CustomPeek Gui/Widgets/FolderFlash Gui/Widgets/FolderView
...
INCLUDEPATH += Gui/Widgets/SidePanel Gui/Widgets/Terminal Gui/Widgets/Terminal/lib Gui/Widgets/TrashManager Gui/Widgets/UtilityBar StyleSheets

DEPENDPATH += . Core Core/AppFile Core/Archive Core/ArgParser Core/CoreTools Core/DeleteManager Core/DeviceInfo
DEPENDPATH += Core/DeviceInfo/QVolumeInfo Core/FileIO Core/FSWatcher Core/IconProvider Core/MimeHandler Core/MultiFile Core/SelectionArea
DEPENDPATH += Core/Server Core/StandardPaths Core/SystemInfo Core/XDG Gui Gui/Dialogs Gui/Dialogs/FileDialog Gui/Dialogs/PropertiesDialog
DEPENDPATH += Gui/Dialogs/SettingsManager Gui/ModelViews Gui/ModelViews/Models Gui/ModelViews/Models/ApplicationsModel
DEPENDPATH += Gui/ModelViews/Models/CatalogModel Gui/ModelViews/Models/FileSystemModel Gui/ModelViews/Models/SidePanelModel
DEPENDPATH += Gui/ModelViews/Models/TrashModel Gui/ModelViews/Views Gui/ModelViews/Views/AppsView Gui/ModelViews/Views/CatalogView
DEPENDPATH += Gui/ModelViews/Views/IconView Gui/ModelViews/Views/OpenWithView Gui/ModelViews/Views/SidePanelView Gui/ModelViews/Views/TrashView
DEPENDPATH += Gui/NewBreezeUI Gui/Others Gui/Others/Settings Gui/Widgets Gui/Widgets/AddressBar Gui/Widgets/BreadCrumbsBar Gui/Widgets/Buttons
DEPENDPATH += Gui/Widgets/ContextMenu Gui/Widgets/CustomActions Gui/Widgets/CustomPeek Gui/Widgets/FolderFlash Gui/Widgets/FolderView
...
DEPENDPATH += Gui/Widgets/SidePanel Gui/Widgets/Terminal Gui/Widgets/Terminal/lib Gui/Widgets/TrashManager Gui/Widgets/UtilityBar StyleSheets
...
HEADERS += Gui/NewBreezeUI/NBTabsBase.hpp
...
SOURCES += Gui/NewBreezeUI/NBTabsBase.cpp
SOURCES += Gui/NewBreezeUI/NBUpdater.cpp
