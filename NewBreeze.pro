...
DEPENDPATH += . Core Core/Archive Core/ConfigParser Core/CoreTools Core/DeleteManager Core/DeviceInfo Core/FileIO Core/FSWatcher Core/Hashes
DEPENDPATH += Core/IconProvider Core/MimeHandler Core/Server Core/StandardPaths Core/SystemInfo
DEPENDPATH += Gui Gui/Dialogs Gui/Dialogs/FileDialog Gui/Dialogs/SettingsManager Gui/ModelViews Gui/ModelViews/Models Gui/ModelViews/Views
DEPENDPATH += Gui/Others Gui/Others/Settings Gui/Others/ThumbsCache Gui/Plugins Gui/Plugins/CustomPeek Gui/Plugins/FolderFlash
DEPENDPATH += Gui/Plugins/ImagePeek Gui/Plugins/WebWatch Gui/Plugins/WordView Gui/Widgets Gui/Widgets/AddressBar Gui/Widgets/BreadCrumbsBar
...
DEPENDPATH += Gui/Widgets/Terminal/lib Gui/Widgets/TitleBar StyleSheets

INCLUDEPATH += . Core Core/Archive Core/ConfigParser Core/CoreTools Core/DeleteManager Core/DeviceInfo Core/FileIO Core/FSWatcher Core/Hashes
INCLUDEPATH += Core/IconProvider Core/MimeHandler Core/Server Core/StandardPaths Core/SystemInfo
INCLUDEPATH += Gui Gui/Dialogs Gui/Dialogs/FileDialog Gui/Dialogs/SettingsManager Gui/ModelViews Gui/ModelViews/Models Gui/ModelViews/Views
INCLUDEPATH += Gui/Others Gui/Others/Settings Gui/Others/ThumbsCache Gui/Plugins Gui/Plugins/CustomPeek Gui/Plugins/FolderFlash
INCLUDEPATH += Gui/Plugins/ImagePeek Gui/Plugins/WebWatch Gui/Plugins/WordView Gui/Widgets Gui/Widgets/AddressBar Gui/Widgets/BreadCrumbsBar
...
INCLUDEPATH += Gui/Widgets/Terminal/lib Gui/Widgets/TitleBar StyleSheets
