...
INCLUDEPATH += Core/FSWatcher Core/IconProvider Core/MimeHandler Core/Server Core/StandardPaths Core/SystemInfo Gui
INCLUDEPATH += Gui/Dialogs Gui/Dialogs/FileDialog Gui/Dialogs/PropertiesDialog Gui/Dialogs/SettingsManager Gui/ModelViews
INCLUDEPATH += Gui/ModelViews/Models Gui/ModelViews/Models/ApplicationsModel Gui/ModelViews/Models/CatalogModel
INCLUDEPATH += Gui/ModelViews/Models/FileSystemModel Gui/ModelViews/Models/OpenWithModel Gui/ModelViews/Models/SidePanelModel
...
DEPENDPATH += Core/FSWatcher Core/IconProvider Core/MimeHandler Core/Server Core/StandardPaths Core/SystemInfo Gui
DEPENDPATH += Gui/Dialogs Gui/Dialogs/FileDialog Gui/Dialogs/PropertiesDialog Gui/Dialogs/SettingsManager Gui/ModelViews
DEPENDPATH += Gui/ModelViews/Models Gui/ModelViews/Models/ApplicationsModel Gui/ModelViews/Models/CatalogModel
DEPENDPATH += Gui/ModelViews/Models/FileSystemModel Gui/ModelViews/Models/OpenWithModel Gui/ModelViews/Models/SidePanelModel
