/*
	*
	* NBCombiDelegate.cpp - ItemDelegate Class for NBIconView class
	*
*/
...
void NBCombiDelegate::paintIcons( QPainter *painter, const QStyleOptionViewItem &option, const QModelIndex &index ) const {
...
void NBCombiDelegate::paintTiles( QPainter *painter, const QStyleOptionViewItem &option, const QModelIndex &index ) const {
...
void NBCombiDelegate::paintDetails( QPainter *painter, const QStyleOptionViewItem &option, const QModelIndex &index ) const {
...
void NBCombiDelegate::paintIconTextDetails( QPainter *painter, QRect &textRect, const QModelIndex &index ) const {
...
void NBCombiDelegate::paintTileTextDetails( QPainter *painter, QRect &textRect, const QModelIndex &index ) const {
...
void NBCombiDelegate::paintExtraDetails( QPainter *painter, QList<QRect> &textRectList, const QModelIndex &index ) const {
