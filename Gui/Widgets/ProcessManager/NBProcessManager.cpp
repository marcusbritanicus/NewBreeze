...
NBProcessWidget::NBProcessWidget( NBCoreProcess *proc ) {
...
void NBProcessWidget::speedCalculator() {
...
void NBProcessWidget::signalRemove() {
...
NBProcessManagerGUI::NBProcessManagerGUI( QWidget *parent ) : NBDialog( parent ) {
	...
	foreach( NBFileIO *io, jobList ) {
		NBProcessWidget *iow = new NBProcessWidget( io );
