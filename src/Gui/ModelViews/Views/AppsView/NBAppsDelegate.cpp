/*
	*
	* NBAppsDelegate.cpp - ItemDelegate Class for NBIconView class
	*
*/
...
void NBAppsDelegate::paintIcons( QPainter *painter, const QStyleOptionViewItem &option, const QModelIndex &index ) const {
...
void NBAppsDelegate::paintTiles( QPainter *painter, const QStyleOptionViewItem &option, const QModelIndex &index ) const {

	paintIcons( painter, option, index );
};

void NBAppsDelegate::paintDetails( QPainter *painter, const QStyleOptionViewItem &option, const QModelIndex &index ) const {

	paintIcons( painter, option, index );
};

void NBAppsDelegate::paintIconTextDetails( QPainter *painter, QRect &textRect, const QModelIndex &index ) const {
...
void NBAppsDelegate::paintTileTextDetails( QPainter *painter, QRect &textRect, const QModelIndex &index ) const {
...
void NBAppsDelegate::paintExtraDetails( QPainter *painter, QList<QRect> &textRectList, const QModelIndex &index ) const {
