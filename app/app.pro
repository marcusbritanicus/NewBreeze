...
INCLUDEPATH += Gui/Widgets/InfoBar Gui/Widgets/InfoPanel Gui/Widgets/ProcessManager Gui/Widgets/SideBar Gui/Widgets/SidePanel Gui/Widgets/SystemMenu Gui/Widgets/Terminal
...
DEPENDPATH += Gui/Widgets/InfoBar Gui/Widgets/InfoPanel Gui/Widgets/ProcessManager Gui/Widgets/SideBar Gui/Widgets/SidePanel Gui/Widgets/SystemMenu Gui/Widgets/Terminal
...
HEADERS += Gui/Widgets/SideBar/NBBookmarkView.hpp
HEADERS += Gui/Widgets/SideBar/NBDeviceView.hpp
HEADERS += Gui/Widgets/SideBar/NBSideBar.hpp
HEADERS += Gui/Widgets/SideBar/NBVfsView.hpp
...
SOURCES += Gui/Widgets/SideBar/NBBookmarkView.cpp
SOURCES += Gui/Widgets/SideBar/NBDeviceView.cpp
SOURCES += Gui/Widgets/SideBar/NBSideBar.cpp
SOURCES += Gui/Widgets/SideBar/NBVfsView.cpp
