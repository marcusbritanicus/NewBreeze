...
{
public:
    QCryptographicHash5::Algorithm method;
    union {
...
/*!
  \class QCryptographicHash5
  \inmodule QtCore

  \brief The QCryptographicHash5 class provides a way to generate cryptographic hashes.
  ...
  QCryptographicHash5 can be used to generate cryptographic hashes of binary or text data.

  Currently MD4, MD5, SHA-1, SHA-224, SHA-256, SHA-384, and SHA-512 are supported.
*/

/*!
  \enum QCryptographicHash5::Algorithm
...
*/
QCryptographicHash5::QCryptographicHash5(Algorithm method)
...
/*!
  Destroys the object.
*/
QCryptographicHash5::~QCryptographicHash5()
{
    delete d;
}
...
/*!
  Resets the object.
*/
void QCryptographicHash5::reset()
{
    switch (d->method) {
    case Sha1:
    ...
    default:
        Q_ASSERT_X(false, "QCryptographicHash5", "Method not compiled in");
        Q_UNREACHABLE();
        break;
#else
    case Md4:
...
/*!
    ...
    hash.
*/
void QCryptographicHash5::addData(const char *data, int length)
{
    switch (d->method) {
    case Sha1:
...
/*!
  \overload addData()
*/
void QCryptographicHash5::addData(const QByteArray &data)
{
...
/*!
  ...
  \since 5.0
 */
bool QCryptographicHash5::addData(QIODevice* device)
{
...
/*!
  ...
  \sa QByteArray::toHex()
*/
QByteArray QCryptographicHash5::result() const
{
    if (!d->result.isEmpty())
        return d->result;
...
*/
QByteArray QCryptographicHash5::hash(const QByteArray &data, Algorithm method)
{
    QCryptographicHash5 hash(method);
    hash.addData(data);
    return hash.result();
}
